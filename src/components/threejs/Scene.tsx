...
export const Scene = ({}: SceneProps) => {
  ...
  return (
    <>
      ...
      <instancedMesh ref={meshRef as any} args={[undefined, undefined, COUNT]} matrixAutoUpdate>
        {/* sphere size */}
      ...
      <EffectComposer>
        <ChromaticAberration
          ...
          offset={new THREE.Vector2(CHROMATIC_ABBERATION_OFFSET, CHROMATIC_ABBERATION_OFFSET)}
